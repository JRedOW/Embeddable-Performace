...
"""This program is a modified version from `hyperfine`."""
...
parser.add_argument(
    "--sel-labels", help="Labels selected for this display (must be in order)"
)
...
if args.sel_labels:
    ...
    for sel_label in args.sel_labels.split(","):
        index = labels.index(sel_label)

        new_labels.append(labels[index])
        new_all_times.append(all_times[index])
